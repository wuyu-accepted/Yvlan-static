...
<style scoped>
.result-detail-layout { --cp-surface-canvas:var(--cp-canvas-obsidian); --cp-surface-default:var(--cp-surface-charcoal); --cp-surface-subtle:var(--cp-surface-charcoal-raised); --cp-surface-raised:var(--cp-surface-charcoal); --cp-surface-selected:color-mix(in srgb,var(--cp-accent-crimson) 14%,var(--cp-surface-charcoal)); --cp-text-primary:var(--cp-text-warm); --cp-text-secondary:var(--cp-text-warm-muted); --cp-text-muted:var(--cp-text-warm-muted); --cp-text-inverse:var(--cp-text-warm); --cp-border-default:var(--cp-border-graphite); --cp-border-subtle:color-mix(in srgb,var(--cp-border-graphite) 72%,transparent); --cp-border-strong:color-mix(in srgb,var(--cp-text-warm-muted) 58%,var(--cp-border-graphite)); --cp-action-primary:var(--cp-accent-crimson); --cp-action-primary-hover:var(--cp-accent-crimson-hover); --cp-tech:var(--cp-text-warm-muted); --cp-evidence-surface:color-mix(in srgb,var(--cp-evidence) 10%,var(--cp-surface-charcoal)); --cp-evidence-text:var(--cp-evidence); width:100%; min-width:0; min-height:100%; max-width:100%; overflow-x:hidden; background:var(--cp-surface-canvas); color:var(--cp-text-primary); color-scheme:dark; }
